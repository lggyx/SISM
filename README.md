...
![登录页面](docs/image/学生信息管理系统/1778636443657.png)

### 首页（学生列表）

![首页](docs/image/学生信息管理系统/1778636463507.png)

### 添加学生

![添加学生](docs/image/学生信息管理系统/1778636498019.png)

### 修改学生

![修改学生](docs/image/学生信息管理系统/1778636514318.png)

### 成绩管理

![成绩管理](docs/image/学生信息管理系统/1778636558355.png)

### 密码修改

![密码修改](docs/image/学生信息管理系统/1778636629729.png)
...
- `docs/学生信息管理系统.md` — 完整的系统分析、设计、实现文档，包含 Mermaid 图表
